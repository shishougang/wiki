...
* Awesome
+ [[http://fffaraz.github.io/awesome-cpp/][A curated list of awesome C/C++ frameworks, libraries, resources,
  and shiny things. ]]
...
+ KDE
 http://www.kde.org/
* Data Visualization
+ [[http://www.matpack.de/][Matpack]] is a C++ numerics and graphics library implementing methods
  that are needed in a scientist's or engineer's everyday life.

+ [[http://www.opendx.org/about.html][OpenDX]] is a uniquely powerful, full-featured software package for
  the visualization of scientific, engineering and analytical data

+ The [[http://www.vtk.org/][Visualization Toolkit (VTK)]] is an open-source, freely available
...
+ [[http://users.fred.net/brv//chart/][GDCHART]]

* Network Programming
** REST[fn:3]
+ C++ RESTful framework -  C++ micro-framework designed to be embedded
  into a wide range of applications.
  https://github.com/corvusoft/restbed
+ C++ REST SDK - asynchronous HTTP client and listener, asynchronous
  Stream, URI, JSON
  http://casablanca.codeplex.com/
+ restful_mapper - ORM for consuming RESTful JSON APIs in C++
  https://github.com/logandk/restful_mapper
+ Simple C++ REST library -  Very simple and self documenting library
  for creating a REST API in your c++ application
  + https://github.com/pdumais/rest
  + http://www.dumaisnet.ca/index.php?article=c3db6d72f1dd661d22f36ea2f76da041
...
[[http://images.amazon.com/images/P/0201309831.01._PE_PI_SCMZZZZZZZ_.jpg]]

This is a great great book that contains answers to about 500
questions on programming, design, analysis and testing. This book is
not for beginners, but for programmers who have figured out the syntax
of the language, and are looking to implement them. If you have
...
[fn:3] http://en.cppreference.com/w/cpp/links/libs
