...
More: [[http://stackoverflow.com/questions/332030/when-should-static-cast-dynamic-cast-and-reinterpret-cast-be-used][When should static_cast, dynamic_cast, const_cast and reinterpret_cast be used?]]
** =static_cast=
...
* instantiate objects from a string holding their class name?[fn:2]
** use a map
#+begin_src c++
...
#+end_src
** to have the types register themselves
...
[fn:2] http://stackoverflow.com/questions/582331/is-there-a-way-to-instantiate-objects-from-a-string-holding-their-class-name
