...
* commit a file and ignore the content changes
...
* git mirror
+ [[https://github.com/RalfJung/git-mirror][git-mirror: Sync your git repositories]]
+ [[https://docs.gitlab.com/ee/workflow/repository_mirroring.html][Repository mirroring]]
