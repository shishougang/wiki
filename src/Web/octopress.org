...
+ [[https://www.narga.net/octopress-moved-wordpress-tips-tricks/][Tips & Tricks for Migrating From WordPress to Octopress]]
+ [[https://www.narga.net/improve-octopress-advanced-tweaks-tips/][Improve Octopress with Advanced Tweaks & Tips]] 
  + Adding Related Post to Octopress
  + Sidebar category list
  + Add a List of Popular Posts
  + Display special characters in markdown on Octopress
  + Custom 404 Page
+ [[http://techtinkering.com/2011/08/17/improving-related-posts-on-jekyll/][Improving the related_posts feature of jekyll]]
+ [[https://harimenon.com/2013/01/27/auto-deploying-to-my-octopress-blog/][Auto-deploying to my Octopress blog with Travis-CI]]
+ [[http://www.railsonmaui.com/blog/2014/03/05/octopress-setup-with-github-and-org-mode-v2/][Org-Mode Octopress Setup V2]]
  + use [[https://github.com/yoshinari-nomura/org-octopress][Org-octopress]] package
+ [[http://blog.codebykat.com/2013/05/23/gorgeous-octopress-codeblocks-with-coderay/][Gorgeous Octopress Codeblocks with CodeRay]]
