...
* run a 32-bit binary on a 64-bit system
#+begin_src sh
bash: ./shank-linux-120720110-1-bin: No such file or directory
#+end_src

To run 32bit executable file in a 64 bit multi-arch Ubuntu system, you
have to add i386 architecture and also you have to install
=libc6:i386=, =libncurses5:i386=, =libstdc++6:i386= these three library
packages.
...
And [[https://launchpadlibrarian.net/186123405/readme.txt][GNU Tools for ARM Embedded Processors Readme]]
