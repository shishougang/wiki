#+TITLE: index
   ...
   + Linux
     ...
     + [[file:Linux/Google Shell Style Notes.org][Google Shell Style Notes]]
   ...
   + Python
     + [[file:Python/Google Python Style Notes.org][Google Python Style Notes]]
   ...
   + Software Engineering
     ...
     + [[file:Software Engineering/google-styleguide.org][google-styleguide]]
   + Web
     + HTML CSS
