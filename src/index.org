#+TITLE: index
   ...
   + Algorithms
     +  Algorithms: Design and Analysis (Part I)
       + [[file:Algorithms/ Algorithms: Design and Analysis (Part I)/Algorithms Design_ Analysis (Part I).org][Algorithms Design_ Analysis (Part I)]]
   ...
   + Misc
     ...
     + Machine Learning
       + Machine Learning(Andrew Ng, Associate Professor)
         + [[file:Misc/Machine Learning/Machine Learning(Andrew Ng, Associate Professor)/Machine Learning Notes.org][Machine Learning Notes]]
     + Math
