#+TITLE: index
   ...
   + Software Engineering
     + Design Patterns
       ...
       + [[file:Software Engineering/Design Patterns/浅谈设计模式9.org][浅谈设计模式: 模式()]]
       + [[file:Software Engineering/Design Patterns/浅谈设计模式12.org][浅谈设计模式: 模式()]]
       + [[file:Software Engineering/Design Patterns/浅谈设计模式11.org][浅谈设计模式: 模式()]]
       + [[file:Software Engineering/Design Patterns/浅谈设计模式10.org][浅谈设计模式: 模式()]]
       + [[file:Software Engineering/Design Patterns/浅谈设计模式1.org][浅谈设计模式一: 策略模式(Strategy)]]
       + [[file:Software Engineering/Design Patterns/浅谈设计模式7.org][浅谈设计模式七: 模式(Command)]]
       ...
       + [[file:Software Engineering/Design Patterns/浅谈设计模式8.org][浅谈设计模式八: 模式()]]
