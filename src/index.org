#+TITLE: index
   ...
   + C-C++
     ...
     + C++
       ...
       + [[file:C-C++/C++/Effective-C++-Notes.org][Effective C++ Notes]]
   ...
   + Linux
     + Networks
       + [[file:Linux/Networks/netfilter.org][Linux Netfilter]]
     + Ubuntu
       + [[file:Linux/Ubuntu/Optimize-SSD-for-Ubuntu-14.04.org][Optimize SSD for Ubuntu 14.04]]
       + [[file:Linux/Ubuntu/do-after-installing-Ubuntu-14.0- LTS.org][do after installing Ubuntu 14.04 LTS]]
